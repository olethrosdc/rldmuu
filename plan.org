...
|  6 | Sarsa / Q-Learning                               |
|----+--------------------------------------------------|
|  7 | Stochastic Approximation / Actor-Critic          |
|----+--------------------------------------------------|
...
** Bayesian Analysis and Estimation
- Conjugate priors (15')
- Beta and Normal example (30')
- Chernoff Bounds and Concentration Inequalities (45')
...
*** Concentration lab
- Construction of credible intervals (30')
- Concentration inequalities (30')
