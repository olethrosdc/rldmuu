...
\begin{exercise}
  ...
  travelling there. Then you obtain a reward\marker{} depending on the location
  that you visit.

  More formally, at time $t$, each model\marker{} $\mu$ makes a prediction
  ...
  Is this a type of bandit\marker{} problem, or something different? How does
